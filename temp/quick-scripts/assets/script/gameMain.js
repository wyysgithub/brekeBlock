...
cc._RF.push(module, '5bd772ZOfNKuYg+HvoQui6f', 'gameMain', __filename);
// script/gameMain.js
...
var strengthenList = [{ index: 1, title: '黄色闪光', digest: '球的速度增加500%', icon: 'ball', ballspeed: 5, ballArea: 0, ballAttach: 0 }, { index: 2, title: '肉弹战车', digest: '球的体积增加500%', icon: 'ball', ballspeed: 0, ballArea: 5, ballAttach: 0 }, { index: 3, title: '无砖能挡', digest: '球的伤害增加500%', icon: 'ball', ballspeed: 0, ballArea: 0, ballAttach: 5 }, { index: 4, title: '强壮', digest: '球的体积增加300%，伤害增加50%', icon: 'ball', ballspeed: 0, ballArea: 3, ballAttach: 0.5 }, { index: 5, title: '精练', digest: '球的速度增加300%，伤害增加100%', icon: 'ball', ballspeed: 3, ballArea: 0, ballAttach: 1 }];
cc.Class({
    ...
    //生成选择卡
    createrSelect: function createrSelect(x, y) {
